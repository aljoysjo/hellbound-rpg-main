...
function App() {
  ...
  const handleBackToModeSelection = () => {
    ...
    setShowNewOnboarding(false); // 🆕 También ocultar nuevo onboarding
    setMode(null);
  };

  // 🆕 FUNCIÓN PARA COMPLETAR NUEVO ONBOARDING
  const handleOnboardingComplete = (sessionData) => {
    console.log('🔄 Completando onboarding con datos:', sessionData);
    
    // Configurar el estado del juego con los datos del onboarding
